    ...
    () => [
      {
        ...
        figmaUrl:
          "https://www.figma.com/proto/cRuRI5gtKFsU1Z3IAe7p9O/Activity-Tracking?node-id=31-1303&t=2Nrsx78KYVLEk6Sz-1&scaling=min-zoom&content-scaling=fixed&page-id=31%3A1302&starting-point-node-id=31%3A1303"
      },
      {
        id: "gestion-juridica",
        title: t("portfolio.carousel.gestionJuridica.title"),
        figmaUrl:
          "https://www.figma.com/proto/Abdhr8NgQ2GSGyyFZs3xSW/Gestion-Juridica?node-id=205-11134&t=AIStKhy89dKlaczt-1&scaling=min-zoom&content-scaling=fixed&page-id=1%3A12"
      },
      {
        id: "medellin-te-escucha",
        title: t("portfolio.carousel.medellinEscucha.title"),
        figmaUrl:
          "https://www.figma.com/proto/9pRSd9UVlSJJIMsh3jtb8l/Medellin-te-Escucha?node-id=1-2&t=CTEeLzJUTbXcvfql-1&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=52%3A1588&show-proto-sidebar=1"
      },
      {
        id: "vamos-med",
        title: t("portfolio.carousel.vamosMed.title"),
        figmaUrl:
          "https://www.figma.com/proto/MyjWA3xhq7I5X5cjFjn6sm/Vamos-Med?node-id=1-2&t=rdp0LE8BSlaf9jcB-1&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=60%3A425"
      },
      {
        id: "ciudadano-360",
        title: t("portfolio.carousel.ciudadano360.title"),
        figmaUrl:
          "https://www.figma.com/proto/eDoipyvrcu1yxKU8WGxOvz/Ciudadano360-Fase-II?node-id=1792-6822&t=QaHHZ6cjPN9K4ns7-1&scaling=min-zoom&content-scaling=fixed&page-id=1492%3A3378&starting-point-node-id=1792%3A6822",
